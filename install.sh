...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                 © AHMAD X CERBERUS              [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED}[+] ================================================ [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]              LICENSY AHMAD X CERBERUS           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Ahmad X C ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @Deliogalilei${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Credit  : Ahmad         ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Ahmad        ${NC}"
